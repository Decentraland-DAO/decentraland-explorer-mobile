...
import EmoteInfo from "../../components/marketplace/EmoteInfo";
...
const EmoteDetails: React.FC<PageProps> = ({ match }) => {
    ...
    useEffect(() => {
        FirebaseAnalytics.logEvent({
            name: "screen_view",
            params: {
                screen_name: "Emote Details",
                screen_class: "EmoteDetails",
            },
        });
    }, []);
    ...
    const shareName = async () => {
        await Share.share({
            url: `https://dcland.app/emote/${match.params.contractAddress}/${match.params.tokenId}`,
    ...
    return (
        <IonPage className="name-details">
            ...
            <IonContent fullscreen>
                <EmoteInfo onNFTInfoLoaded={onNFTInfoLoaded} contractAddress={match.params.contractAddress} tokenId={match.params.tokenId}></EmoteInfo>
            </IonContent>
        </IonPage>
    )
}
