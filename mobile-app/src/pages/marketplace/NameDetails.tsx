...
import NameInfo from "../../components/marketplace/NameInfo";
...
const NameDetails: React.FC<PageProps> = ({ match }) => {
    ...
    useEffect(() => {
        FirebaseAnalytics.logEvent({
            name: "screen_view",
            params: {
                screen_name: "Name Details",
                screen_class: "NameDetails",
            },
        });
    }, []);
    ...
    const shareName = async () => {
        await Share.share({
            url: `https://dcland.app/name/${match.params.contractAddress}/${match.params.tokenId}`,
    ...
    return (
        <IonPage className="name-details">
            ...
            <IonContent fullscreen>
                <NameInfo onNFTInfoLoaded={onNFTInfoLoaded} contractAddress={match.params.contractAddress} tokenId={match.params.tokenId}></NameInfo>
            </IonContent>
        </IonPage>
    )
}
